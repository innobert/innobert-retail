...
def ver_papelera_ventas(parent):
    ...
    columnas = ("ID", "N°", "Cliente", "Número Factura", "Total", "Fecha", "Hora", "Usuario", "Eliminada")
    ...
    def cargar_pagina():
        ...
        registros = ServicioPapeleraVentas.obtener_pagina(offset, registros_por_pagina, filtro_actual)
