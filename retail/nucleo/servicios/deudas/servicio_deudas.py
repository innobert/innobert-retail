...
Servicio que encapsula toda la lógica de negocio para el módulo de Deudas.
Incluye validación de stock, gestión del carrito de deudas, obtención de datos
de clientes y productos, y creación de deudas.
"""
...
class DeudasServicio:
    ...
    Todas las operaciones son estáticas y reciben el carrito como parámetro.
    """
    ...
    def confirmar_deuda(
        ...
        """
        Crea la deuda en la base de datos usando el carrito actual.
        Retorna el resultado de crear_deuda (id_deuda, total, saldo, numero_factura).
