...
Servicio para gestionar la lógica del carrito de ventas:
...
class ServicioCarritoVentas:
    ...
    def actualizar_cantidad_en_carrito(
        ...
        # No se modifica la lista original, pero se devuelve la misma referencia
        return carrito, item
    ...
    def calcular_totales_por_cliente(carrito: List[Dict[str, Any]]) -> Dict[str, float]:
        """
        Retorna un diccionario con el total por cliente.
        Clave: nombre del cliente (cadena vacía para venta rápida).
        """
        totales = {}
        for item in carrito:
