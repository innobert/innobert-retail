...
class ServicioDiario:
    ...
    @staticmethod
    def contar_registros(fecha: str) -> Any:
    ...
    @staticmethod
    def obtener_pagina(fecha: str, offset: int, limit: int) -> List[Tuple[Any, ...]]:
        """
    ...
    @staticmethod
    def formatear_registros_para_tabla(registros: List[Tuple[Any, ...]]) -> List[Tuple[Any, ...]]:
        """
