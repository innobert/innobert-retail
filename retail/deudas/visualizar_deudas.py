...
from retail.nucleo.servicios.deudas.servicio_visualizar_deudas import (
    ServicioVisualizarDeudas,
)
...
def ver_detalle_deuda(parent: Any, id_deuda: int) -> None:
    """
    ...
    tk.Label(
        ...
        bg="#FFFFFF",
        fg="#333",
    ).grid(row=2, column=2, sticky="w", padx=(30, 5), pady=4)
    tk.Label(
        info_grid,
        text=peso_colombiano(datos["saldo"]),
        font=("Helvetica", 12, "bold"),
        bg="#FFFFFF",
        fg="#C62828",
    ...
    tree = ttk.Treeview(
        frame_tabla, columns=columns, show="headings", style="DetalleDeuda.Treeview"
    )
